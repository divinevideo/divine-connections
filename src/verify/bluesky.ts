// ABOUTME: Bluesky proof-post verifier: reads AT Protocol identity-link records first,
// ABOUTME: then falls back to checking post text for the claimant's npub.
