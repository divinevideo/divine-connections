// ABOUTME: Twitter/X proof-post verifier via the public oEmbed endpoint.
// ABOUTME: Checks the tweet author matches the claimed identity and the html contains the npub.
