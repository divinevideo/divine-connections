// ABOUTME: Embedded-mode NIP-07 bridge: routes window.nostr calls to a trusted
// ABOUTME: parent Divine frame over postMessage when the page runs in an iframe.// Embedded-mode bridge installed when verifyer.divine.video is loaded inside
