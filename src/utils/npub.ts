// ABOUTME: Bech32 helpers converting between hex pubkeys and npub strings.
// ABOUTME: Used wherever a verifier must match the claimant's npub in proof content.
