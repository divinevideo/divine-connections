// ABOUTME: Fixed-window rate limiter backed by the shared CACHE_KV namespace.
// ABOUTME: One KV namespace serves negative verify results, NIP-05 results, and limits.
